...
namespace UltimateTeam.Toolkit.Factories
{
    public class FutRequestFactories
    {
        ...
        public Func<ClubItemSearchParameters, IFutRequest<ClubItemsResponse>> ClubItemsRequestFactory
        {
            get
            {
                return _clubItemsRequestFactory ??
                       (_clubItemsRequestFactory =
                           clubItemSearchParameters => new ClubItemsRequest(clubItemSearchParameters));
            }
            set { _clubItemsRequestFactory = value; }
        }
